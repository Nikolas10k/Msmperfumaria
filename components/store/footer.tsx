      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-text-muted">
            <li><Link href="/perfumes" className="hover:text-rose">Todos os perfumes</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-text-muted">
            ...
            {whatsappHref && (
              <li>
                <a href={whatsappHref} target="_blank" rel="noreferrer" className="hover:text-rose">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-text-muted">
            {settings?.instagram_url && (
              <li><a href={settings.instagram_url} target="_blank" rel="noreferrer" className="hover:text-rose">Instagram</a></li>
            )}
            {settings?.facebook_url && (
              <li><a href={settings.facebook_url} target="_blank" rel="noreferrer" className="hover:text-rose">Facebook</a></li>
            )}
            {settings?.tiktok_url && (
              <li><a href={settings.tiktok_url} target="_blank" rel="noreferrer" className="hover:text-rose">TikTok</a></li>
            )}
          </ul>
        </div>
      </div>
